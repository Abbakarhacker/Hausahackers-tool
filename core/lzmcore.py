## lzmcore.py - useful module of Hausahackers
##
import os, sys, time
...
def hvirus():
	...
	os.system('pkg install git curl python2 -y')
	os.system(' git clone https://github.com/Abbakarhacker/H-Virus.git')
	os.system('mv H-Virus {}'.format(homeDir))
	print('###### Done')
	backtomenu_option() 
